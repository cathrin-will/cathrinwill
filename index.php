			...
			<div class="grid-wrapper">
				<div class="grid">
					...
					<div class="grid__item one-whole  lap-and-up-two-thirds">
						<p>I'm an experienced <strong>Front-end Developer</strong> having worked at a variety of digital and marketing agencies for over 3 years. With strong skills in writing HMTL and CSS, utilising Sass and grunt for development.</p>
					...
					<div class="grid__item one-whole  lap-and-up-one-half">
						<ul>
							<li>HTML <small>(Excellent)</small></li>
							<li>CSS <small>(Excellent)</small></li>
							<li>Sass/SCSS <small>(Good)</small></li>
							<li>LESS <small>(Satisfactory)</small></li>
							<li>iQuery <small>(Good)</small></li>
							<li>JavaScript <small>(Satisfactory)</small></li>
							<li>Grunt <small>(Satisfactory)</small></li>
						</ul>
					</div><!--
					--><div class="grid__item one-whole  lap-and-up-one-half">
						<ul>
